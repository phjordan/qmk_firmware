...
// ......................................................... Number Keypad Layer
  ...
  [_NUMBER] = {
    {_______, KC_F,    MT_E,    KC_D,    _______, ___x___, ___x___, DE_SLSH, KC_7,    KC_8,    KC_9,    DE_ASTR},
    {OS_CTL,  GT_C,    AT_B,    ST_A,    _______, ___x___, ___x___, TD_DOT,  KC_4,    KC_5,    KC_6,    DE_MINS},
    {_______, DE_HASH, SM_G,    DE_BSLS, _______, ___x___, ___x___, TD_COMM, KC_1,    KC_2,    KC_3,    DE_PLUS},
#ifdef THUMB_0
    {___x___, ___x___, ___x___, ___fn__, ___x___, ___x___, ___x___, DE_0,    LT_EQL,  ___x___, ___x___, ___x___},
#else
    {___x___, ___x___, ___x___, ___fn__, ___x___, ___x___, ___x___, DE_EQL,  LT_0,    ___x___, ___x___, ___x___},
#endif
  },
#else
  // .-----------------------------------------------------------------------------------.
  ...
  [_NUMBER] = {
    {_______, KC_F,    MT_E,    KC_D,    _______, _______, _______, DE_SLSH, KC_7,    KC_8,    KC_9,    DE_ASTR},
    {OS_CTL,  GT_C,    AT_B,    LT_A,    _______, _______, _______, DE_DOT,  KC_4,    KC_5,    KC_6,    DE_MINS},
    {_______, DE_HASH, MT_X,    S(KC_G), _______, _______, _______, TD_COMM, KC_1,    KC_2,    KC_3,    DE_PLUS},
#ifdef THUMB_0
    {___x___, ___x___, ___x___, ___fn__, ___x___, ___x___, ___x___, DE_0,    LT_EQL,  ___x___, ___x___, ___x___},
#else
    {___x___, ___x___, ___x___, ___fn__, ___x___, ___x___, ___x___, DE_EQL,  LT_0,    ___x___, ___x___, ___x___},
  ...
  [_NUMSYM] = {
    {_______, _______, _______, ___x___, _______, _______, _______, TD_LCBR, DE_AMPR, DE_QUES, DE_COLN, DE_RCBR},
    {___x___, ___x___, ___x___, ___fn__, _______, _______, _______, TD_LPRN, DE_DLR,  DE_PERC, DE_CIRC, DE_RPRN},
    {_______, _______, _______, ___x___, _______, _______, _______, TD_LBRC, DE_LESS, DE_TILD, DE_MORE, DE_RBRC},
...
// ............ .................................................. Function Keys
  ...
  [_FNCKEY] = {
    ...
    {_______, _______, _______, _______, ___fn__, ___fn__, _______, DE_PLUS, _______, _______, _______, _______},
  },
#else
// ......................................................... Number Keypad Layer
#ifdef SHIFT_SYMBOLS
