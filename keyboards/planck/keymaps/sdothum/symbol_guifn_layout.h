...
// ..................................................... Symbol Navigation Layer
  ...
  [_SYMBOL] = LAYOUT_planck_grid(
    _______, DE_TILD, DE_ASTR, DE_AMPR, _______, ___x___, ___x___, _______, KC_HOME, KC_UP,   KC_END,  KC_PGUP,
    OS_CTL,  SM_CIRC, SM_PERC, SM_DLR,  _______, ___x___, ___x___, _______, KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN,
    _______, DE_HASH, DE_AT,   DE_EXLM, _______, ___x___, ___x___, _______, _______, _______, _______, _______,
  ...
  [_SYMBOL] = LAYOUT_planck_grid(
    DE_LCBR, DE_DOT,  DE_ASTR, DE_AMPR, TD_RCBR, _______, _______, _______, KC_HOME, KC_UP,   KC_END,  KC_PGUP,
    SM_LPRN, SM_CIRC, SM_PERC, SM_DLR,  TD_RPRN, _______, _______, _______, LT_LFTX, KC_DOWN, KC_RGHT, KC_PGDN,
    DE_LBRC, DE_HASH, DE_AT,   DE_EXLM, TD_RBRC, _______, _______, _______, _______, _______, _______, _______,
  ...
  [_SYMREG] = LAYOUT_planck_grid(
    ___x___, DE_QUES, DE_PLUS, DE_TILD, ___x___, _______, _______, _______, ___x___, ___x___, ___x___, ___x___,
    ___x___, DE_LESS, DE_EQL,  TD_RNGL, ___x___, _______, _______, _______, ___fn__, ___x___, ___x___, ___x___,
